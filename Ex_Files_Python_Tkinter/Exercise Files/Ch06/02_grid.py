...
# Rows/columns start at 0 then go down/right on the grid
...
# 10px of padding around green label
...
root.rowconfigure(1, weight=3)      # Will expand 3 times as fast as row0
root.columnconfigure(2, weight=1)   # Only column that will expand since others have weight of 0
